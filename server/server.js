...
async function sendSms(to, message){
  ...
  try{
    ...
    const url = SENDAFRICA_BASE_URL + '/sms/';
    ...
    if(!resp.ok){
      console.error('[otp] SendAfrica imekataa ujumbe:', resp.status, 'URL:', url, 'BASE:', SENDAFRICA_BASE_URL, data);

/**
 * Daftari Plus — backend v3 (multi-tenant, zero external dependencies)
 * -----------------------------------------------------
 ...
 * that specific business. All data (products, sales, expenses, debts)
 * is scoped to business_id — no business can see another's data.
 */
